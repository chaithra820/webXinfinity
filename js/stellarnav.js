	...
	$.fn.stellarNav = function(options, width, breakpoint) {
		...
		return this.each( function() {
			...
			if (settings.locationBtn && !(settings.position == 'right' || settings.position == 'left')) {
				var btn = '<a href="'+ settings.locationBtn +'" class="location-btn-mobile ' + cssClass + '" ><svg id="icon-location"></svg> <span>Location</span></a>';
				nav.find('a.menu-toggle').after(btn);
			}
			...
			$('.navbar-toggler, .stellarnav-open').on('click', function(e) {
				e.preventDefault();
				...
				// }
				// else if($('.close-nav').css('display') == 'none'){
				// 	$('.open-nav').css('display','none');
				// 	$('.close-nav').css('display','block');
				// }
			...
			nav.find('li .clicked').on('click', function(e) {
				e.preventDefault();
				$(this).parent('li').children('ul').stop(true, true).slideToggle(settings.openingSpeed);
				$(this).parent('li').toggleClass('open');
			});
